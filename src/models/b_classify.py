...
class BClassifier:
    """
    A custom Classifier model to get predicts for train and test
    ---
    """
    model = DecisionTreeClassifier(criterion="entropy")
    
    def fit(self, verbose=False):
        x_train, x_test, y_train, y_test, self.label_encoder = get_data(split_type="b_classification", verbose=verbose)
    ...
    def __repr__(self):
        return f"sklearn.DecisionTreeClassifier()"